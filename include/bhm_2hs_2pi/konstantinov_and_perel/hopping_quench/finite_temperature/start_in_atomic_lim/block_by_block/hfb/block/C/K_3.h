...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_BLOCK_C_K_3_H
...
class K_3: public NSA3::mat
{
public:
    K_3(const NSA4::builder_set& block_builder_set);
