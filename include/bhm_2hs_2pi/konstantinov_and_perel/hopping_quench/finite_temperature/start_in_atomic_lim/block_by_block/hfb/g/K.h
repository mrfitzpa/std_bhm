...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/g/K.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_G_K_H
...
class K: public NSA3::element
{
public:
    K(const NSA4::element_params& g_element_params);
