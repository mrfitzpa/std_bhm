...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_BLOCK_C_RHO_2_H
...
namespace C
{
namespace rho_2_detail
{

namespace NSA1 = std_bhm::bhm_2hs_2pi::konstantinov_and_perel::hopping_quench;
namespace NSA2 = NSA1::finite_temperature::start_in_atomic_lim::block_by_block;
namespace NSA3 = NSA2::hfb::block::C;
...
class rho_2: public NSA3::mat
{
public:
    rho_2(const NSA4::builder_set& block_builder_set);
