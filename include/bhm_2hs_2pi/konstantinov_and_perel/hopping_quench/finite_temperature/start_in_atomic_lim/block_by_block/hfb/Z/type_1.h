...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/Z/type_1.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Z_TYPE_1_H
...
class type_1: public NSA3::element
{
public:
    type_1(const dbl_vec& n_array);
...
} // end of type_1_detail namespace
