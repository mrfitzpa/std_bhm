...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_BLOCK_C_RHO_1_H
...
class rho_1: public NSA3::mat
{
public:
    rho_1(const NSA4::builder_set& block_builder_set);
