...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/y_K_eqn_alg.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Y_K_EQN_ALG_H
...
{
public:
    y_K_eqn_alg(const NSA3::builder_set& builder_set);
...
} // end of y_K_eqn_alg_detail namespace
...
y_K_eqn_alg_detail::y_K_eqn_alg;
