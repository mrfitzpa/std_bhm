...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/Y/K_rho.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Y_K_RHO_H
...
class K_rho: public NSA3::element
{
public:
    K_rho(const NSA4::params& k_eqn_params, double step_offset);
