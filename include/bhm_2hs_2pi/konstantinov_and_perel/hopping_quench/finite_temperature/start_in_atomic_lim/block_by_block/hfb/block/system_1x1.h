...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_BLOCK_SYSTEM_1X1_H
...
class system_1x1: public NSA3::system
{
public:
    system_1x1(const NSA4::mat& C_mat, const NSA5::vec& b_vec);
...
} // end of system_1x1_detail namespace
