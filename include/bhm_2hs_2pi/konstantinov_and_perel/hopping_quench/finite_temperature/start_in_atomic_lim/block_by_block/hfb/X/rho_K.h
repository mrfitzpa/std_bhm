...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/X/rho_K.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_X_RHO_K_H
...
{
public:
    rho_K(const NSA4::params& k_eqn_params, double step_offset);
