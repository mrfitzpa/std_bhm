...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/Z/set.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Z_SET_H
...
{
public:
    set(const dbl_vec& n_array);

    const NSA3::element& get_type_1() const;
    const NSA3::element& get_type_2() const;
    const NSA3::element& get_type_3() const;
    const NSA3::element& get_type_4() const;
    const NSA3::element& get_type_5() const;
    const NSA3::element& get_type_6() const;
