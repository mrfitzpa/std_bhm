...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/X/element.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_X_ELEMENT_H
...
private:
    virtual cmplx_dbl do_eval(int l1, int l2, int l3) const = 0;
};
