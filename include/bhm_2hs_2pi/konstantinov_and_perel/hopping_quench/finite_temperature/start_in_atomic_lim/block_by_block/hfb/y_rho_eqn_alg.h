...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/y_rho_eqn_alg.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Y_RHO_EQN_ALG_H
...
namespace y_rho_eqn_alg_detail
{

namespace NSA1 = std_bhm::bhm_2hs_2pi::konstantinov_and_perel::hopping_quench;
namespace NSA2 = NSA1::finite_temperature::start_in_atomic_lim::block_by_block;
namespace NSA3 = NSA2::hfb::block::builder_set_detail;

class y_rho_eqn_alg
{
public:
    y_rho_eqn_alg(const NSA3::builder_set& builder_set);
...
} // end of y_rho_eqn_alg_detail namespace
...
y_rho_eqn_alg_detail::y_rho_eqn_alg;
