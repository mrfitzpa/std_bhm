...
// /gen_abs_filename_for_n_k_data_file.h
...
GEN_ABS_FILENAME_FOR_N_K_DATA_FILE_H
...
namespace gen_abs_filename_for_n_k_data_file_detail
{
...
std::string gen_abs_filename_for_n_k_data_file(
                const NSA3::alg_1_params& sim_params,
		const int_vec& k_ints);

} // end of gen_abs_filename_for_n_k_data_file_detail namespace
...
finite_temperature::start_in_atomic_lim::block_by_block::hfb::sim::\
gen_abs_filename_for_n_k_data_file_detail::gen_abs_filename_for_n_k_data_file;
