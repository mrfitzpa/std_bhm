...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/array_gen/Y.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_ARRAY_GEN_Y_H
...
dbl_vec Y(const NSA3::Y_params& y_params);
