...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_BLOCK_C_K_4_H
...
class K_4: public NSA3::mat
{
public:
    K_4(const NSA4::builder_set& block_builder_set);
