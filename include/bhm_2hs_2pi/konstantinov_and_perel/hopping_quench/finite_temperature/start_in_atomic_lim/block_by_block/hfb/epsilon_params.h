...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/epsilon_params.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_EPSILON_PARAMS_H
...
{
public:
    epsilon_params(const NSA1::quench_params& q_params, const dbl_vec& k_vec);

    NSA1::quench_params get_quench_params() const;
...
} // end of epsilon_params_detail namespace
...
epsilon_params_detail::epsilon_params;
