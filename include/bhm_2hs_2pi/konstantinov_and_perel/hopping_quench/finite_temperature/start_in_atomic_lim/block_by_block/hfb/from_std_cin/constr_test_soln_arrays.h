...
{
namespace constr_test_soln_arrays_detail
{

namespace NSA1 = std_bhm::bhm_2hs_2pi::konstantinov_and_perel::hopping_quench;
namespace NSA2 = NSA1::finite_temperature::start_in_atomic_lim::block_by_block;
namespace NSA3 = NSA2::hfb::soln_arrays_detail;

NSA3::soln_arrays constr_test_soln_arrays();

} // end of constr_test_soln_arrays_detail namespace
...
from_std_cin::constr_test_soln_arrays_detail::constr_test_soln_arrays;
