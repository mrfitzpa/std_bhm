...
{
public:
    set(const NSA4::set_params& params);

    const NSA5::base& get_rho_rho_1() const;
    const NSA5::base& get_rho_rho_2() const;

    const NSA5::base& get_rho_K_1() const;
    const NSA5::base& get_rho_K_2() const;

    const NSA5::base& get_K_rho_1() const;
    const NSA5::base& get_K_rho_2() const;
