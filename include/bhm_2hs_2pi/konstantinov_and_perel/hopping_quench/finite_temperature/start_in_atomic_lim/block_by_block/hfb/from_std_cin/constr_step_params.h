...
{
namespace constr_step_params_detail
{
...
NSA3::step_params constr_step_params();

} // end of constr_step_params_detail namespace
...
from_std_cin::constr_step_params_detail::constr_step_params;
