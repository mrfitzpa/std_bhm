...
{
namespace constr_M_set_ctor_args_detail
{

namespace NSA1 = std_bhm::bhm_2hs_2pi::konstantinov_and_perel::hopping_quench;
namespace NSA2 = NSA1::finite_temperature::start_in_atomic_lim::block_by_block;
namespace NSA3 = NSA2::hfb::M::set_ctor_args_detail;

using dbl_vec = std::vector<double>;

NSA3::set_ctor_args constr_M_set_ctor_args(const dbl_vec& n_array);

} // end of constr_M_set_ctor_args_detail namespace
...
from_std_cin::constr_M_set_ctor_args_detail::constr_M_set_ctor_args;
