...
class atomic_func_params
{
public:
    atomic_func_params(const local_params& l_params,
...
} // end of atomic_func_params_detail namespace
...
finite_temperature::start_in_atomic_lim::block_by_block::hfb::array_gen::\
atomic_func_params_detail::atomic_func_params;
