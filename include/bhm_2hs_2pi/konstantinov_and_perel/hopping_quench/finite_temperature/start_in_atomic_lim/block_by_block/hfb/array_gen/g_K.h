...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_ARRAY_GEN_G_K_H
...
cmplx_vec g_K(const NSA3::atomic_func_params& af_params);

} // end of g_K_detail namespace
