...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/Z/type_6.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Z_TYPE_6_H
...
class type_6: public NSA3::element
{
public:
    type_6(const dbl_vec& n_array);
...
} // end of type_6_detail namespace
