...
// /finite_temperature/start_in_atomic_lim/block_by_block/hfb/simp_quad/set.h
...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_SIMP_QUAD_SET_H
...
namespace NSA5 = NSA4::set_detail;

namespace NSA6 = NSA3::M::set_detail;
namespace NSA7 = NSA3::soln_arrays_detail;
namespace NSA8 = NSA4::element_detail;

class set
{
public:
    set(const NSA6::set& M_set, const NSA7::soln_arrays& soln);

    NSA8::element get_rho_rho() const;
    NSA8::element get_rho_K() const;
    NSA8::element get_K_rho() const;
