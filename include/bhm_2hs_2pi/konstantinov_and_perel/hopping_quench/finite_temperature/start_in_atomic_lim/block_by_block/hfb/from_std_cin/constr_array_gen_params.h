...
{
namespace constr_array_gen_params_detail
{
...
NSA3::array_gen_params constr_array_gen_params();

} // end of constr_array_gen_params_detail namespace
...
from_std_cin::constr_array_gen_params_detail::constr_array_gen_params;
