...
FINITE_TEMPERATURE_START_IN_ATOMIC_LIM_BLOCK_BY_BLOCK_HFB_Y_ELEMENT_PARAMS_H
...
class element_params
{
public:
    element_params(const local_params& l_params,
...
} // end of element_params_detail namespace
...
finite_temperature::start_in_atomic_lim::block_by_block::hfb::Y::\
element_params_detail::element_params;
