...
NSA1::kinetic_propagator::kinetic_propagator(const local_params& l_params)
...
NSA1::kinetic_propagator::impl::impl(const local_params& l_params)
    : l_params{l_params},
...
cmplx_dbl NSA1::kinetic_propagator::do_eval(double t) const
{
