...
start_in_atomic_lim/block_by_block/hfb/array_gen/g_rho.h"
#include "bhm_2hs_2pi/konstantinov_and_perel/hopping_quench/finite_temperature/\
...
namespace NSA4 = NSA3::g_rho_detail;
...
cmplx_vec NSA4::g_rho(const ::NSA3::atomic_func_params& af_params)
{
	...
	array_form[l] = spectral_func.eval(s);
    }
