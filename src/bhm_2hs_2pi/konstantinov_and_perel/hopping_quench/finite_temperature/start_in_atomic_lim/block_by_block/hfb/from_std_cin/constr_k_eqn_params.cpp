...
// Construct a 'k_eqn::params' object by reading values from std::cin.
namespace NSA1 = std_bhm::bhm_2hs_2pi::konstantinov_and_perel::hopping_quench;
namespace NSA2 = NSA1::finite_temperature::start_in_atomic_lim::block_by_block;
namespace NSA3 = NSA2::hfb;
namespace NSA4 = NSA3::from_std_cin;
namespace NSA5 = NSA4::constr_k_eqn_params_detail;
namespace NSA6 = NSA3::k_eqn;

NSA6::params NSA5::constr_k_eqn_params()
{
    ...
    return ::NSA6::params{l_params, e_params, s_params};
}
