...
NSA3::type_6::type_6(const dbl_vec& n_array)
    : pimpl{ spimpl::make_impl<impl>(n_array) }
{}



// type_6::impl constructor.
namespace NSA1 = std_bhm::bhm_2hs_2pi::konstantinov_and_perel::hopping_quench;
namespace NSA2 = NSA1::finite_temperature::start_in_atomic_lim::block_by_block;
namespace NSA3 = NSA2::hfb::Z;
...
NSA3::type_6::impl::impl(const dbl_vec& n_array)
    : n_array(n_array)
{}
...
double NSA3::type_6::do_eval(int l1, int l2) const
{
    const auto index = l2 - 1;
