...
NSA3::rho_K::rho_K(const ::NSA4::params& k_eqn_params, double step_offset)
...
NSA3::rho_K::impl::impl(const ::NSA4::params& k_eqn_params, double step_offset)
...
cmplx_dbl NSA3::rho_K::do_eval(int l1, int l2, int l3) const
{
